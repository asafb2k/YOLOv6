...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--img-size', default=896, type=int, help='train, val image size (pixels)')
    ...
    parser.add_argument('--name', default='exp_4_yolov6_medium_added_augmentations_896_res', type=str, help='experiment name, saved to output_dir/name')
    ...
    parser.add_argument('--stop_aug_last_n_epoch', default=75, type=int, help='stop strong aug at last n epoch, neg value not stop, default 15')
