...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-file', default='./configs/yolov6n6_finetune.py', type=str, help='experiments description file')
    ...
    parser.add_argument('--batch-size', default=192, type=int, help='total batch size for all GPUs')
    ...
    parser.add_argument('--name', default='exp_1_yolov6_nano_changed_their_augmentations_a_bit', type=str, help='experiment name, saved to output_dir/name')
