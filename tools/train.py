...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-file', default='./configs/yolov6l6_finetune.py', type=str, help='experiments description file')
    parser.add_argument('--img-size', default=960, type=int, help='train, val image size (pixels)')
    parser.add_argument('--rect', action='store_true', help='whether to use rectangular training, default is False')
    parser.add_argument('--batch-size', default=12, type=int, help='total batch size for all GPUs')
    parser.add_argument('--epochs', default=100, type=int, help='number of total epochs to run')
    parser.add_argument('--workers', default=12, type=int, help='number of data loading workers (default: 8)')
    ...
    parser.add_argument('--heavy-eval-range', default=20, type=int,help='evaluating every epoch for last such epochs (can be jointly used with --eval-interval)')
    ...
    parser.add_argument('--name', default='exp_4_yolov6_large_added_augmentations_960_res', type=str, help='experiment name, saved to output_dir/name')
    ...
    parser.add_argument('--stop_aug_last_n_epoch', default=50, type=int, help='stop strong aug at last n epoch, neg value not stop, default 15')
