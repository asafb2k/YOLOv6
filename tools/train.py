...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--img-size', default=1280, type=int, help='train, val image size (pixels)')
    ...
    parser.add_argument('--name', default='exp_3_yolov6_nano_added_augmentations_1280_res', type=str, help='experiment name, saved to output_dir/name')
